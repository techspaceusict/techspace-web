...
def index(request):
	...
	return render(request,'clubs/renderedusict/index.html', {'info':info, 'team': team, 'event': event})
...
class EventListView(EventView):
	...
	def get_context_data(self,**kwargs):
		...
		context['club_events'] = Events.objects.filter(club=Events.renderedusict)
		return context